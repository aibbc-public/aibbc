...
contract AIBBC is ERC20Pausable, Ownable { // Contract name is AIBBC
  string public constant name = "AIBBC"; // token name
  string public constant symbol = "AIBBC"; // symbol name
